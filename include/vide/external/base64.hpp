...
#ifndef VIDE_EXTERNAL_BASE64_HPP_
#define VIDE_EXTERNAL_BASE64_HPP_
...
inline std::string encode(unsigned const char* bytes_to_encode, size_t in_len) {
	std::string ret;
	int i = 0;
	int j = 0;
...
#endif
#endif // VIDE_EXTERNAL_BASE64_HPP_
