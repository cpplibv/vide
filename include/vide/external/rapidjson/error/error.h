...
#ifndef VIDE_RAPIDJSON_ERROR_ERROR_H_
#define VIDE_RAPIDJSON_ERROR_ERROR_H_
...
/*! \defgroup VIDE_RAPIDJSON_ERRORS RapidJSON error handling */

///////////////////////////////////////////////////////////////////////////////
// VIDE_RAPIDJSON_ERROR_CHARTYPE
...
*/
#ifndef VIDE_RAPIDJSON_ERROR_CHARTYPE
#define VIDE_RAPIDJSON_ERROR_CHARTYPE char
#endif

///////////////////////////////////////////////////////////////////////////////
// VIDE_RAPIDJSON_ERROR_STRING

//! Macro for converting string literal to \ref VIDE_RAPIDJSON_ERROR_CHARTYPE[].
/*! \ingroup VIDE_RAPIDJSON_ERRORS
    By default this conversion macro does nothing.
    On Windows, user can define this macro as \c _T(x) for supporting both
    unicode/non-unicode settings.
*/
#ifndef VIDE_RAPIDJSON_ERROR_STRING
#define VIDE_RAPIDJSON_ERROR_STRING(x) x
#endif
...
\code
    ...
    const VIDE_RAPIDJSON_ERROR_CHARTYPE* s = GetParseError(document.GetParseErrorCode());
\endcode
*/
typedef const VIDE_RAPIDJSON_ERROR_CHARTYPE* (*GetParseErrorFunc)(ParseErrorCode);
...
\code
    ...
    const VIDE_RAPIDJSON_ERROR_CHARTYPE* s = GetValidateError(validator.GetInvalidSchemaCode());
\endcode
*/
typedef const VIDE_RAPIDJSON_ERROR_CHARTYPE* (*GetValidateErrorFunc)(ValidateErrorCode);
...
\code
    ...
    const VIDE_RAPIDJSON_ERROR_CHARTYPE* s = GetSchemaError(validator.GetInvalidSchemaCode());
\endcode
*/
typedef const VIDE_RAPIDJSON_ERROR_CHARTYPE* (*GetSchemaErrorFunc)(SchemaErrorCode);
...
\code
    ...
    const VIDE_RAPIDJSON_ERROR_CHARTYPE* s = GetPointerParseError(pointer.GetParseErrorCode());
\endcode
*/
typedef const VIDE_RAPIDJSON_ERROR_CHARTYPE* (*GetPointerParseErrorFunc)(PointerParseErrorCode);
...
#endif // VIDE_RAPIDJSON_ERROR_ERROR_H_
