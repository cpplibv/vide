...
#ifndef VIDE_RAPIDJSON_URI_H_
#define VIDE_RAPIDJSON_URI_H_
...
private:
    ...
    Ch* CopyPart(Ch* to, Ch* from, std::size_t len) {
        VIDE_RAPIDJSON_ASSERT(to != 0);
        VIDE_RAPIDJSON_ASSERT(from != 0);
    ...
    void RemoveDotSegments() {
        ...
        while (pathpos < pathlen) {
            ...
            if (slashpos == 2 && path_[pathpos] == '.' && path_[pathpos + 1] == '.') {
                ...
                VIDE_RAPIDJSON_ASSERT(newpos == 0 || path_[newpos - 1] == '/');
                ...
                VIDE_RAPIDJSON_ASSERT(newpos <= pathpos);
