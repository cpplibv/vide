...
#include <vide/types/functional.hpp> // The default comparator for queue is less
#include <vide/types/std_deque.hpp> // The default container for queue is deque, so let's include that too
